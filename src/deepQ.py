...
class deepQ():
    #[80,80],4,4,
    def __init__(self,game_env,caffe_file,num_actions,preprocess_func,
        game_skip=80,n_episodes=10000000,
        ...
        learning_interval=4,frames_per_action=1,minibatch_size=32,
        save_rewards=False,fresh=False):
        ...
        self.checkpoint_path = str("./saved_networks/%s/%s.ckpt"%(self.network_name,self.network_name))
    ...
    def train(self):
        ...
        reward_data_path = str("./saved_networks/%s/%s.rewards"%(self.network_name,self.network_name))
        max_q_path = str("./saved_networks/%s/%s.qs"%(self.network_name,self.network_name))
        ...
        while True:
            ...
            print("                                                             \r"+"Iteration {}\tTraining step {}/{} ({:.1f})%\tLoss {:5f}\tMean Max-Q {:2f}  ".format(
                iteration, step, self.n_episodes, step * 100 / self.n_episodes, loss, mean_max_q), end="")
            #start_time = time.time()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_episodes",help="Number of episodes to train",required=False,type=int,default=10000000)
    ...
    parser.add_argument("--checkpoint_interval",help="How many steps before updating checkpoint",required=False,type=int,default=500)
    ...
    network = deepQ(env,proto_file,num_actions,preprocess_func,
        ...
        save_rewards=args.save_rewards,fresh=args.fresh)
