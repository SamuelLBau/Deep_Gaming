...
class deepQ():
    ...
    def __init__(self,game_env):
        self.env = game_env
    def train(self,n_episodes=100,e=.5,CNN_struct=[]):
        sess = tf.InteractiveSession()
        s, readout, h_fc1=self.asri_create_network()
        self.asri_train_network(self.env,s,readout,h_fc1,sess)
        '''
        ...
        sys.stdout.flush()
        '''
    def build_CNN(self,CNN_struct):
        '''
            Currently, this uses exactly the net used by DeepLearningVideoGames
            https://github.com/asrivat1/DeepLearningVideoGames/blob/master/deep_q_network.py
            #TODO: Buildthis from arguements and test multiple different structures

        '''
        return self.asri_create_network()
